  ...
  <div>
    ...
    <div v-if="view.isLoaded">
      ...
      <form class="form-horizontal" v-on:submit.prevent="saveSettings('mac')">
        <div :class="['form-group', errors.MACValidation.hasError ? 'has-error' : '']">
          ...
          <div class="col-sm-5">
            <toggle-button
              ...
              :value="settings.mac.MACValidation"
              :sync="true"
        ...
        <div
          v-if="settings.mac.MACValidation"
...
export default {
  ...
  methods: {
    ...
    toggleSettingsMACValidation() {
      this.settings.mac.MACValidation = !this.settings.mac.MACValidation;
    },
    saveSettings(type) {
      var context = this;
      var settingsObj = {
      ...
      nethserver.exec(
        ["nethserver-firewall-base/settings/validate"],
        settingsObj,
        null,
        function(success) {
