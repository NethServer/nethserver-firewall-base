...
$L['LSM_Params'] = 'Links status monitor';
$L['MaxNumberPacketLoss_label'] = 'Disable link after # lost pings (2-99)';
$L['MaxPercentPacketLoss_label'] = 'Disable link over % lost pings (1-100)';
$L['PingInterval_label'] = 'Ping interval in seconds (1-60)';
$L['NotifyWan_label'] = 'Send mail notification if a link is disabled';
